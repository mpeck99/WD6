        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li class="active"><a href="navigation.php">Home<span class="sr-only">(current)</span></a></li>
              <li><a href="about.php">About</a></li>
              <li><a href="contact.php">Contact</a></li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Links <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="https://www.fullsail.edu">Full Sail University</a></li>
                  <li><a href="https://mpeck99.github.io/Portfolio"/>Portfolio</a></li>
                </ul>
              </li>
            </ul>
    ...
    <div class="container">
      ...
      <a class="carousel-control-next" href="#myCarousel" role="button" data-slide="next">
        ...
        <span class="sr-only">Next</span>
            ...
            <div class="progress" data-toggle="popover" data-placement="bottom" data-content="This is a progres bar at 10%!" style="margin-top:10px">
          <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 10%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
      </div>
      <div class="progress" data-toggle="popover" data-placement="top" data-content="This is a progres bar at 25%!">
      ...
      <div class="progress"data-toggle="popover" data-placement="bottom" data-content="This is a progres bar at 50%!">
      ...
      <div class="progress" data-toggle="popover" data-placement="right" data-content="This is a progres bar at 100%!">
